...
UNIT_GROUP_MAP = {
    ...
    "保健室同盟": ["山神カルタ", "東堂コハク"],
    "組体操": ["渋谷ハジメ", "夕陽リリ"],
    "西弦緑渡": ["春崎エアル", "グウェル・オス・ガール", "소나기（ソ・ナギ）"],
    "私立だいさんじ学園": ["渚トラウト"],
    "にじさんじカゲプロ": ["赤城ウェン", "星導ショウ", "榊ネス"],
    "アニソンカラオケ同好会": ["フレン・E・ルスタリオ", "先斗寧", "星導ショウ"],
    "にじさんじ乙女ゲーム製作委員会": ["笹木咲", "春崎エアル", "不破湊"],
    "Alri": ["雪城眞尋"],
    "ねないこ": ["西園チグサ"],
    "にじさんじON砲": ["小野町春香"],
    "にじさんじダンス部": ["山神カルタ", "東堂コハク", "レイン・パターソン", "セラフ・ダズルガーデン", "倉持めると"],
    "しかばねぱんだ": ["三枝明那", "黛灰", "不破湊"],
    "解散GIG": ["本間ひまわり", "鷹宮リオン", "来栖夏芽"],
    "cresc.": ["える", "雪城眞尋"],
    "ERRors": ["奈羅花", "渡会雲雀", "榊ネス"],
    "SitR名古屋": ["緑仙", "葉加瀬冬雪", "渡会雲雀", "先斗寧", "小清水透"],
    "レッドガーネット": ["花畑チャイカ", "舞元啓介", "葉加瀬冬雪", "加賀美ハヤト", "倉持めると", "赤城ウェン", "栞葉るり", "榊ネス"],
    "にじさんじラジオ体操部": [
    ...
    "2年4組": ["オリバー・エバンス", "ベルモンド・バンデラス"],
    "いちから中央銀行": ["桜凛月", "Nara Haramaung", "세피나（セフィナ）"],
    "SEEDs1期生": ["樋口楓", "森中花咲", "桜凛月", "成瀬鳴", "小野町春香", "三枝明那", "健屋花那", "グウェル・オス・ガール", "弦月藤士郎", "甲斐田晴", "민수하（ミン・スゥーハ）", "오지유（オ・ジユ）", "세피나（セフィナ）", "宇佐美リト", "魁星", "Maria Marionette", "Vezalius Bandage"],
    "忖度フィニッシャーズ": ["える", "愛園愛美"],
