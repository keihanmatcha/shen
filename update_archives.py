...
KEYWORD_GROUPS = {
    "MEMBERS": [
        ...
        # 外部・声優・その他
        "歌衣メイカ", "渋谷ハル", "熊谷タクマ", "かなえ先生", "天開司","水槽","HIMEHINA","YuNi","ときのそら","空澄セラ","我部りえる",
        "百花繚乱", "ぽんぽこ", "ピーナッツくん", "ばあちゃる", "英リサ","幸祜","コーサカ","MonsterZ MATE","Yaca","DJ WILDPARTY","りうら","律可",
        "兎麹まり", "一ノ瀬うるは", "神威きゅぴ", "橘ひなの", "八雲ぺに", "ゴモリー", "多井隆晴", "松本吉弘", "前野智昭", "土田玲央",
        "平川大輔","アンジョー","猫又おかゆ","アザミ","超学生","響木アオ","超学生", "龍惺ろたん"
    ],
    "UNITS": [
